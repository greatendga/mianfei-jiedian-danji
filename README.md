...
> A quick-start page for Mihomo readers who want the day’s article, a short import path, and a clean archive.
...
请打开上面的博客文章，在正文“免费订阅地址”区域获取当天可用入口。快速入口更适合正文页维护，GitHub 只做索引和提示。
...
- 内容重点：Mihomo 订阅导入、Clash Meta 兼容、代理组刷新和格式检测；2026年9月14日更新；香港、日本、新加坡、美国 等地区；100 Mbps 公共限速
...
本站每日北京时间 00:00 自动处理免费节点用户：重置流量、刷新订阅 Token、写入服务端动态数据，并同步 GitHub 分享仓库。Mihomo 用户先看当天文章，再按快速步骤导入。 仓库里的 `sub/latest.txt` 只保存当天文章链接，不保存真实订阅地址。
